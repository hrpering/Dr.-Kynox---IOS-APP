...
struct ModeSelectionPage: View {
        ...
        Button {
            ...
            .overlay(
                RoundedRectangle(cornerRadius: AppRadius.lg, style: .continuous)
                    .stroke(hasSelection ? .white.opacity(0.2) : AppColor.primary.opacity(0.22), lineWidth: 1)
            )
    ...
    private func modeCard(mode: CaseLaunchConfig.Mode,
        ...
        Button {
            ...
            .background(selectedMode == mode ? background : AppColor.surfaceElevated)
            .overlay(
                RoundedRectangle(cornerRadius: AppRadius.lg, style: .continuous)
...
struct DifficultyCard: View {
    ...
    var body: some View {
        ...
        .background(isSelected ? config.bg : AppColor.surfaceElevated)
...
struct MetricBand: View {
    ...
    private var titleColor: Color {
        style == .hero ? AppColor.textSecondary : AppColor.textSecondary
    }

    private var valueColor: Color {
        style == .hero ? AppColor.textPrimary : AppColor.textPrimary
    }
    ...
    private var itemBorder: Color {
        style == .hero ? AppColor.border : AppColor.border
    }
}
